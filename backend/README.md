...
The current playable game lives in `../frontend`. Backend API routes, database access, auth/session handling, and leaderboard persistence are still planned work.
