...
`POST /api/puzzle/past` returns a signed, untracked puzzle token for a previous official daily puzzle. Dates must be earlier than today; dates before `2021-06-19` are clamped to the first playable puzzle.
